...
class Player(Sprite):
    def __init__(self, game):
        ...
        self.last_update = 0
        self.load_images()
        # used spritesheet_jump.png spritesheet
        self.image = self.game.spritesheet.get_image(382, 510, 182, 123)
    ...
    def load_images(self):
        ...
        self.duck_frame = self.game.spritesheet.get_image(814, 1417, 90, 155)
...
class Platform(Sprite):
    def __init__(self, game, x, y):
        ...
        Sprite.__init__(self, self.groups)
        self.game = game
        images = [self.game.spritesheet.get_image(218, 1456, 201, 100), 
